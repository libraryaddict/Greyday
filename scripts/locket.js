...
var Banish = /*#__PURE__*/_createClass(function Banish() {_classCallCheck(this, Banish);_defineProperty(this, "monster", void 0);_defineProperty(this, "turnBanished", void 0);_defineProperty(this, "banisher", void 0);});
...
function greyDuringFightMacro(settings) {
  ...
  macro.trySkill(external_kolmafia_namespaceObject.Skill.get("Bowl Straight Up"));
...
function greyKillingBlow(outfit) {
  ...
  if ((0,external_kolmafia_namespaceObject.haveEffect)(external_kolmafia_namespaceObject.Effect.get("Temporary Amnesia")) == 0) {
    ...
    if ((0,external_kolmafia_namespaceObject.lastMonster)().physicalResistance < 70) {
...
var AdventureSettings = /*#__PURE__*/function () {function AdventureSettings() {GreyLocations_classCallCheck(this, AdventureSettings);GreyLocations_defineProperty(this, "startOfFightMacro", void 0);GreyLocations_defineProperty(this, "duringFightMacro", void 0);GreyLocations_defineProperty(this, "finishingBlowMacro", void 0);GreyLocations_defineProperty(this, "choices", void 0);GreyLocations_defineProperty(this, "dontBanishThese", void 0);GreyLocations_defineProperty(this, "banishThese", void 0);}GreyLocations_createClass(AdventureSettings, [{ key: "addBanish", value:
...
var AbsorbsProvider = /*#__PURE__*/function () {function AbsorbsProvider() {GreyAbsorber_classCallCheck(this, AbsorbsProvider);}GreyAbsorber_createClass(AbsorbsProvider, [{ key: "getRolloverAdvs", value:
    ...
    function getAbsorbedMonstersFromInstance() {
      ...
      var absorbedProp = "_absorbedMonstersToday";

      if ((0,external_kolmafia_namespaceObject.getProperty)(absorbedProp) == "") {
      ...
      reabsorbed),_step4;try {for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {var m = _step4.value;
        ...
        }} catch (err) {_iterator4.e(err);} finally {_iterator4.f();}var _iterator5 = GreyAbsorber_createForOfIteratorHelper(

      external_kolmafia_namespaceObject.Location.all()),_step5;try {for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {var loc = _step5.value;var _iterator6 = GreyAbsorber_createForOfIteratorHelper(
          loc.combatQueue.split("; ")),_step6;try {for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {var s = _step6.value;
              if (s.length == 0) {
                continue;
              }

              var monster = external_kolmafia_namespaceObject.Monster.get(s);
    ...
    {var includeSkills = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      var map = new Map();var _iterator7 = GreyAbsorber_createForOfIteratorHelper(

      AbsorbsProvider.loadAbsorbs().filter(
      (a) =>
      (includeSkills || a.adventures > 0) &&
      defeated.get(a.monster) != Reabsorbed.REABSORBED)),_step7;try {for (_iterator7.s(); !(_step7 = _iterator7.n()).done;)
        {var absorb = _step7.value;var _iterator8 = GreyAbsorber_createForOfIteratorHelper(
          getLocations(absorb.monster)),_step8;try {for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {var l = _step8.value;
              if (map.has(l)) {
                continue;
              }
...
var QuestL10GiantGround = /*#__PURE__*/function () {function QuestL10GiantGround() {QuestL10GiantGround_classCallCheck(this, QuestL10GiantGround);QuestL10GiantGround_defineProperty(this, "boning",
    ...
    "The Castle in the Clouds in the Sky (Ground Floor)"));}QuestL10GiantGround_createClass(QuestL10GiantGround, [{ key: "run", value:
...
function QuestL11Black_classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function QuestL11Black_defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function QuestL11Black_createClass(Constructor, protoProps, staticProps) {if (protoProps) QuestL11Black_defineProperties(Constructor.prototype, protoProps);if (staticProps) QuestL11Black_defineProperties(Constructor, staticProps);Object.defineProperty(Constructor, "prototype", { writable: false });return Constructor;}function QuestL11Black_defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var QuestL11Black = /*#__PURE__*/function () {function QuestL11Black() {QuestL11Black_classCallCheck(this, QuestL11Black);QuestL11Black_defineProperty(this, "boots",
    ...
    external_kolmafia_namespaceObject.Location.get("The Black Forest"));}QuestL11Black_createClass(QuestL11Black, [{ key: "level", value:
    ...
    function status() {
      var status = (0,external_kolmafia_namespaceObject.getProperty)("questL11Black");
    ...
    function run() {
      ...
      if ((0,external_kolmafia_namespaceObject.availableAmount)(external_kolmafia_namespaceObject.Item.get("reassembled blackbird")) == 0) {
      ...
      return {
        ...
        run: () => {
          ...
          try {
            ...
            (0,external_kolmafia_namespaceObject.availableAmount)(external_kolmafia_namespaceObject.Item.get("Blackberry")) >= 3)
            {
...
var QuestL11DesertExplore = /*#__PURE__*/function () {function QuestL11DesertExplore() {QuestL11DesertExplore_classCallCheck(this, QuestL11DesertExplore);QuestL11DesertExplore_defineProperty(this, "hydrated",
    ...
    external_kolmafia_namespaceObject.Item.get("survival knife"));}QuestL11DesertExplore_createClass(QuestL11DesertExplore, [{ key: "getId", value:
    ...
    function run() {
      if ((0,external_canadv_ash_namespaceObject.canAdv)(this.oasis) && (0,external_kolmafia_namespaceObject.haveEffect)(this.hydrated) == 0) {
        return {
...
var QuestL11PyramidMiddle = /*#__PURE__*/function () {function QuestL11PyramidMiddle() {QuestL11PyramidMiddle_classCallCheck(this, QuestL11PyramidMiddle);QuestL11PyramidMiddle_defineProperty(this, "ratTangle",
    ...
    external_kolmafia_namespaceObject.Item.get("Familiar scrapbook"));QuestL11PyramidMiddle_defineProperty(this, "banisher",
    external_kolmafia_namespaceObject.Skill.get("Show Your Boring Familiar Pictures"));QuestL11PyramidMiddle_defineProperty(this, "servant",
    ...
    function run() {
      ...
      return {
        ...
        run: () => {
          ...
          settings.addBanish(external_kolmafia_namespaceObject.Monster.get("Tomb Asp"));
          ...
          AbsorbsProvider.getReabsorbedMonsters().includes(this.servant))
          {
            ...
            settings.addBanish(external_kolmafia_namespaceObject.Monster.get("Tomb Servant"));
          }
...
var QuestL11Business = /*#__PURE__*/function () {function QuestL11Business() {QuestL11TempleBusiness_classCallCheck(this, QuestL11Business);QuestL11TempleBusiness_defineProperty(this, "files",
    ...
    function status() {
      ...
      if ((0,external_kolmafia_namespaceObject.availableAmount)(this.completeFile) > 0 && this.delayUntilNextNC() > 0) {
        return QuestStatus.READY;
      }
...
var QuestL11HiddenBookMatches = /*#__PURE__*/function () {function QuestL11HiddenBookMatches() {QuestL11HiddenBookMatches_classCallCheck(this, QuestL11HiddenBookMatches);QuestL11HiddenBookMatches_defineProperty(this, "book",
    ...
    external_kolmafia_namespaceObject.Location.get("The Hidden Park"));}QuestL11HiddenBookMatches_createClass(QuestL11HiddenBookMatches, [{ key: "getId", value:
    ...
    function run() {
      var needToAdv =
      (0,external_kolmafia_namespaceObject.availableAmount)(this.book) == 0 && GreySettings.isHardcoreMode();
...
var QuestL11TempleGrabWool = /*#__PURE__*/function () {function QuestL11TempleGrabWool() {QuestL11TempleGrabWool_classCallCheck(this, QuestL11TempleGrabWool);QuestL11TempleGrabWool_defineProperty(this, "wool",
    ...
    external_kolmafia_namespaceObject.Monster.get("Baa-relief sheep"));}QuestL11TempleGrabWool_createClass(QuestL11TempleGrabWool, [{ key: "getId", value:
...
var QuestL11TempleUnlock = /*#__PURE__*/function () {function QuestL11TempleUnlock() {QuestL11TempleUnlock_classCallCheck(this, QuestL11TempleUnlock);QuestL11TempleUnlock_defineProperty(this, "coin",
    ...
    external_kolmafia_namespaceObject.Location.get("The Spooky Forest"));QuestL11TempleUnlock_defineProperty(this, "choices", void 0);}QuestL11TempleUnlock_createClass(QuestL11TempleUnlock, [{ key: "getId", value:
...
var Quest12WarNuns = /*#__PURE__*/function () {function Quest12WarNuns() {QuestL12Nuns_classCallCheck(this, Quest12WarNuns);QuestL12Nuns_defineProperty(this, "loc",
    ...
    external_kolmafia_namespaceObject.Effect.get("Winklered"));}QuestL12Nuns_createClass(Quest12WarNuns, [{ key: "hasAlreadyPulled", value:
...
var QuestL12Worms = /*#__PURE__*/function () {function QuestL12Worms() {QuestL12Worms_classCallCheck(this, QuestL12Worms);QuestL12Worms_defineProperty(this, "effects",
    ...
    function mustBeDone() {
      return (
        this.effects.
        filter((i) => i[0] != null).
        map((i) => (0,external_kolmafia_namespaceObject.effectModifier)(i[0], "Effect")).
        find((e) => (0,external_kolmafia_namespaceObject.haveEffect)(e) > 0) != null);
...
var QuestL12GrabWarOutfit = /*#__PURE__*/function () {function QuestL12GrabWarOutfit() {QuestL12GrabWarOutfit_classCallCheck(this, QuestL12GrabWarOutfit);QuestL12GrabWarOutfit_defineProperty(this, "location",
    ...
    external_kolmafia_namespaceObject.Effect.get("Everything Looks Yellow"));}QuestL12GrabWarOutfit_createClass(QuestL12GrabWarOutfit, [{ key: "getId", value:
...
var QuestL12War = /*#__PURE__*/function () {function QuestL12War() {QuestL12War_classCallCheck(this, QuestL12War);QuestL12War_defineProperty(this, "children",
    ...
    new QuestL12WarFlyers()]);}QuestL12War_createClass(QuestL12War, [{ key: "getLocations", value:
...
var QuestTowerShadow = /*#__PURE__*/function () {function QuestTowerShadow() {QuestTowerShadow_classCallCheck(this, QuestTowerShadow);QuestTowerShadow_defineProperty(this, "badge",
    ...
    external_kolmafia_namespaceObject.Item.get("Gauze garter"));}QuestTowerShadow_createClass(QuestTowerShadow, [{ key: "getId", value:
...
var QuestL2SpookyLarva = /*#__PURE__*/function () {function QuestL2SpookyLarva() {QuestL2Larva_classCallCheck(this, QuestL2SpookyLarva);QuestL2Larva_defineProperty(this, "location",
    external_kolmafia_namespaceObject.Location.get("The Spooky Forest"));}QuestL2Larva_createClass(QuestL2SpookyLarva, [{ key: "level", value:
...
var QuestL4BatsCenter = /*#__PURE__*/function () {function QuestL4BatsCenter() {QuestL4BatsCenter_classCallCheck(this, QuestL4BatsCenter);QuestL4BatsCenter_defineProperty(this, "fire",
    ...
    external_kolmafia_namespaceObject.Item.get("sonar-in-a-biscuit"));}QuestL4BatsCenter_createClass(QuestL4BatsCenter, [{ key: "getId", value:
...
var QuestL6FriarElbow = /*#__PURE__*/function () {function QuestL6FriarElbow() {QuestL6FriarElbow_classCallCheck(this, QuestL6FriarElbow);QuestL6FriarElbow_defineProperty(this, "item",
    ...
    external_kolmafia_namespaceObject.Location.get("Dark Elbow of the Woods"));}QuestL6FriarElbow_createClass(QuestL6FriarElbow, [{ key: "level", value:
...
var QuestL6FriarHeart = /*#__PURE__*/function () {function QuestL6FriarHeart() {QuestL6FriarHeart_classCallCheck(this, QuestL6FriarHeart);QuestL6FriarHeart_defineProperty(this, "item",
    ...
    external_kolmafia_namespaceObject.Location.get("Dark Heart of the Woods"));}QuestL6FriarHeart_createClass(QuestL6FriarHeart, [{ key: "level", value:
...
var QuestL6FriarNeck = /*#__PURE__*/function () {function QuestL6FriarNeck() {QuestL6FriarNeck_classCallCheck(this, QuestL6FriarNeck);QuestL6FriarNeck_defineProperty(this, "item",
    ...
    external_kolmafia_namespaceObject.Location.get("Dark Neck of the Woods"));}QuestL6FriarNeck_createClass(QuestL6FriarNeck, [{ key: "level", value:
...
var CryptL7Template = /*#__PURE__*/function () {function CryptL7Template() {CryptTemplate_classCallCheck(this, CryptL7Template);CryptTemplate_defineProperty(this, "swords",
    ...
    "white sword",
    "sweet ninja sword"].
    map((s) => external_kolmafia_namespaceObject.Item.get(s)));}CryptTemplate_createClass(CryptL7Template, [{ key: "getSword", value:
    ...
    function adjustRetroCape() {
      (0,external_kolmafia_namespaceObject.equip)(external_kolmafia_namespaceObject.Item.get("Unwrapped knock-off retro superhero cape"));
...
var CryptL7DirtyMan = /*#__PURE__*/function (_CryptL7Template) {QuestL7CryptDirtyMan_inherits(CryptL7DirtyMan, _CryptL7Template);var _super = QuestL7CryptDirtyMan_createSuper(CryptL7DirtyMan);function CryptL7DirtyMan() {var _this;QuestL7CryptDirtyMan_classCallCheck(this, CryptL7DirtyMan);for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}_this = _super.call.apply(_super, [this].concat(args));QuestL7CryptDirtyMan_defineProperty(QuestL7CryptDirtyMan_assertThisInitialized(_this), "loc",
    ...
    external_kolmafia_namespaceObject.Item.get("industrial fire extinguisher"));return _this;}QuestL7CryptDirtyMan_createClass(CryptL7DirtyMan, [{ key: "run", value:
...
var QuestL8MountainBoss = /*#__PURE__*/function () {function QuestL8MountainBoss() {QuestL8MountainBoss_classCallCheck(this, QuestL8MountainBoss);QuestL8MountainBoss_defineProperty(this, "peak",
    ...
    function run() {
      var outfit = new GreyOutfit().addBonus("+cold res");
...
var QuestL8MountainGoats = /*#__PURE__*/function () {function QuestL8MountainGoats() {QuestL8MountainGoats_classCallCheck(this, QuestL8MountainGoats);QuestL8MountainGoats_defineProperty(this, "goats",
    ...
    external_kolmafia_namespaceObject.Item.get("Goat Cheese"));}QuestL8MountainGoats_createClass(QuestL8MountainGoats, [{ key: "getId", value:
...
var QuestL8MountainOreMan = /*#__PURE__*/function (_QuestL8MountainOre) {QuestL8MountainOreMan_inherits(QuestL8MountainOreMan, _QuestL8MountainOre);var _super = QuestL8MountainOreMan_createSuper(QuestL8MountainOreMan);function QuestL8MountainOreMan() {var _this;QuestL8MountainOreMan_classCallCheck(this, QuestL8MountainOreMan);for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}_this = _super.call.apply(_super, [this].concat(args));QuestL8MountainOreMan_defineProperty(QuestL8MountainOreMan_assertThisInitialized(_this), "mountainMan",
    ...
    external_kolmafia_namespaceObject.Effect.get("Everything Looks Yellow"));return _this;}QuestL8MountainOreMan_createClass(QuestL8MountainOreMan, [{ key: "getId", value:
...
var ABooHandler = /*#__PURE__*/function () {function ABooHandler() {QuestL9AbooPeak_classCallCheck(this, ABooHandler);QuestL9AbooPeak_defineProperty(this, "clue",
    ...
    [13, 25, 50, 125, 250]);}QuestL9AbooPeak_createClass(ABooHandler, [{ key: "level", value:
...
var QuestCouncil = /*#__PURE__*/function () {
  ...
  function QuestCouncil() {QuestCouncil_classCallCheck(this, QuestCouncil);QuestCouncil_defineProperty(this, "lastLevelVisited", (0,external_kolmafia_namespaceObject.toInt)((0,external_kolmafia_namespaceObject.getProperty)("lastCouncilVisit")));QuestCouncil_defineProperty(this, "quests", []);
...
var ManorBathroom = /*#__PURE__*/function () {function ManorBathroom() {QuestManorBathroom_classCallCheck(this, ManorBathroom);QuestManorBathroom_defineProperty(this, "location",
    ...
    external_kolmafia_namespaceObject.Item.get("Lady Spookyraven's powder puff"));}QuestManorBathroom_createClass(ManorBathroom, [{ key: "level", value:
...
var ManorBedroom = /*#__PURE__*/function () {function ManorBedroom() {QuestManorBedroom_classCallCheck(this, ManorBedroom);QuestManorBedroom_defineProperty(this, "location",
    ...
    "Wardröb nightstand"].
    map((m) => external_kolmafia_namespaceObject.Monster.get(m)));}QuestManorBedroom_createClass(ManorBedroom, [{ key: "needCamera", value:
...
var QuestManorBillards = /*#__PURE__*/function () {function QuestManorBillards() {QuestManorBillards_classCallCheck(this, QuestManorBillards);QuestManorBillards_defineProperty(this, "billards",
    ...
    external_kolmafia_namespaceObject.Item.get("[7302]Spookyraven library key"));}QuestManorBillards_createClass(QuestManorBillards, [{ key: "getId", value:
    ...
    function run() {
      ...
      outfit.addItem(external_kolmafia_namespaceObject.Item.get("pool cue"));
...
var ManorGallery = /*#__PURE__*/function () {function ManorGallery() {QuestManorGallery_classCallCheck(this, ManorGallery);QuestManorGallery_defineProperty(this, "location",
    ...
    external_kolmafia_namespaceObject.Item.get("serpentine sword"));}QuestManorGallery_createClass(ManorGallery, [{ key: "level", value:
...
var QuestManorKitchen = /*#__PURE__*/function () {function QuestManorKitchen() {QuestManorKitchen_classCallCheck(this, QuestManorKitchen);QuestManorKitchen_defineProperty(this, "kitchen",
    ...
    external_kolmafia_namespaceObject.Skill.get("Conifer Polymers"));}QuestManorKitchen_createClass(QuestManorKitchen, [{ key: "getId", value:
    ...
    function status() {
      ...
      if (!(0,external_kolmafia_namespaceObject.haveSkill)(this.stenchResist)) {
        return QuestStatus.FASTER_LATER;
      }
...
var QuestManorLibrary = /*#__PURE__*/function () {function QuestManorLibrary() {QuestManorLibrary_classCallCheck(this, QuestManorLibrary);QuestManorLibrary_defineProperty(this, "library",
    ...
    external_kolmafia_namespaceObject.Monster.get("Banshee Librarian"));QuestManorLibrary_defineProperty(this, "book",
    external_kolmafia_namespaceObject.Item.get("Familiar scrapbook"));QuestManorLibrary_defineProperty(this, "banisher",
    external_kolmafia_namespaceObject.Skill.get("Show Your Boring Familiar Pictures"));QuestManorLibrary_defineProperty(this, "sweep",
    ...
    function run() {
      ...
      return {
        ...
        run: () => {
          ...
          } else if ((0,external_kolmafia_namespaceObject.availableAmount)(this.killingJar) > 0) {
...
var QuestCar = /*#__PURE__*/function () {function QuestCar() {QuestCar_classCallCheck(this, QuestCar);QuestCar_defineProperty(this, "tinkersThingy",
    ...
    external_kolmafia_namespaceObject.Item.get("Dope Wheels"));}QuestCar_createClass(QuestCar, [{ key: "level", value:
...
var QuestManorLights = /*#__PURE__*/function () {
  ...
  function QuestManorLights() {QuestManorLights_classCallCheck(this, QuestManorLights);QuestManorLights_defineProperty(this, "choices", [890, 891, 892, 893, 894, 895, 896, 897, 898, 899, 900, 901, 902, 903]);QuestManorLights_defineProperty(this, "elizibeth", [[external_kolmafia_namespaceObject.Location.get("The Haunted Storage Room"), 3], [external_kolmafia_namespaceObject.Location.get("The Haunted Laundry Room"), 3], [external_kolmafia_namespaceObject.Location.get("The Haunted Bathroom"), 3], [external_kolmafia_namespaceObject.Location.get("The Haunted Kitchen"), 4], [external_kolmafia_namespaceObject.Location.get("The Haunted Library"), 2], [external_kolmafia_namespaceObject.Location.get("The Haunted Ballroom"), 2], [external_kolmafia_namespaceObject.Location.get("The Haunted Gallery"), 4]]);QuestManorLights_defineProperty(this, "stephen", [[external_kolmafia_namespaceObject.Location.get("The Haunted Bedroom"), [1, 3, 1]], [external_kolmafia_namespaceObject.Location.get("The Haunted Nursery"), [1, 2, 2, 1, 1]], [external_kolmafia_namespaceObject.Location.get("The Haunted Conservatory"), [1, 2, 2]], [external_kolmafia_namespaceObject.Location.get("The Haunted Billiards"), [1, 2, 2]], [external_kolmafia_namespaceObject.Location.get("The Haunted Wine Cellar"), [1, 2, 2, 3]], [external_kolmafia_namespaceObject.Location.get("The Haunted Boiler Room"), [1, 2, 2]], [external_kolmafia_namespaceObject.Location.get("The Haunted Laboratory"), [1, 1, 3, 1, 1]]]);QuestManorLights_defineProperty(this, "elizabethRewards", [external_kolmafia_namespaceObject.Item.get("Elizabeth's Dollie"), external_kolmafia_namespaceObject.Item.get("Elizabeth's paintbrush")]);QuestManorLights_defineProperty(this, "stephsRewards", [external_kolmafia_namespaceObject.Item.get("Stephen's lab coat"), external_kolmafia_namespaceObject.Item.get("Stephen's secret formula")]);QuestManorLights_defineProperty(this, "goose", external_kolmafia_namespaceObject.Familiar.get("Grey Goose"));var _iterator = QuestManorLights_createForOfIteratorHelper(
    ...
    function shouldDoSteve() {
      return (
        this.isSteveReady() && (
        !this.isSteveFight() || (0,external_kolmafia_namespaceObject.familiarWeight)(this.goose) >= 6));
    ...
    function isTime() {
      ...
      return (last + (0,external_kolmafia_namespaceObject.totalTurnsPlayed)()) % 37 == 0;
      ...
      return {
        ...
        run: () => {
          ...
          if ((0,external_kolmafia_namespaceObject.currentRound)() != 0) {
            ...
            null,
            new AdventureSettings().setStartOfFightMacro(
            Macro.skill(external_kolmafia_namespaceObject.Skill.get("Emit Matter Duplicating Drones")).trySkill(
            external_kolmafia_namespaceObject.Skill.get("Emit Matter Duplicating Drones"))));
...
var QuestInitialStart = /*#__PURE__*/function () {function QuestInitialStart() {QuestInitialStart_classCallCheck(this, QuestInitialStart);QuestInitialStart_defineProperty(this, "property",
    ...
    external_kolmafia_namespaceObject.Item.get("MayDay™ supply package"));}QuestInitialStart_createClass(QuestInitialStart, [{ key: "getLocations", value:
    ...
    function run() {
      return {
        ...
        run: () => {
          ...
          (0,external_kolmafia_namespaceObject.cliExecute)("breakfaster");
        } };
...
;// CONCATENATED MODULE: ./src/quests/custom/QuestWorkshed.ts
function QuestWorkshed_classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function QuestWorkshed_defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function QuestWorkshed_createClass(Constructor, protoProps, staticProps) {if (protoProps) QuestWorkshed_defineProperties(Constructor.prototype, protoProps);if (staticProps) QuestWorkshed_defineProperties(Constructor, staticProps);Object.defineProperty(Constructor, "prototype", { writable: false });return Constructor;}function QuestWorkshed_defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}





var QuestWorkshed = /*#__PURE__*/function () {function QuestWorkshed() {QuestWorkshed_classCallCheck(this, QuestWorkshed);QuestWorkshed_defineProperty(this, "lastChecked",
    "_lastCheckedCabinet");QuestWorkshed_defineProperty(this, "hat",
    external_kolmafia_namespaceObject.Item.get("Ice Crown"));QuestWorkshed_defineProperty(this, "pants",
    external_kolmafia_namespaceObject.Item.get("frozen jeans"));}QuestWorkshed_createClass(QuestWorkshed, [{ key: "hasConsults", value:
...
var QuestCustomPurchases = /*#__PURE__*/function () {function QuestCustomPurchases() {QuestCustomPurchases_classCallCheck(this, QuestCustomPurchases);QuestCustomPurchases_defineProperty(this, "toPurchase",
    ["sombrero-mounted sparkler"].map((s) => external_kolmafia_namespaceObject.Item.get(s)));}QuestCustomPurchases_createClass(QuestCustomPurchases, [{ key: "getId", value:
...
var QuestSkillRegistry = /*#__PURE__*/function () {
  ...
  function QuestSkillRegistry() {QuestSkillRegistry_classCallCheck(this, QuestSkillRegistry);QuestSkillRegistry_defineProperty(this, "children", []);
    ...
    */
    ...
    this.addSkill("Skills / MPRegen", external_kolmafia_namespaceObject.Skill.get("Hivemindedness"));
...
var QuestGrabHippyOutfit = /*#__PURE__*/function () {function QuestGrabHippyOutfit() {QuestGrabNormalHippyOutfit_classCallCheck(this, QuestGrabHippyOutfit);QuestGrabNormalHippyOutfit_defineProperty(this, "hippyCamp",
    ...
    external_kolmafia_namespaceObject.Item.get("Battery (9-Volt)"));}QuestGrabNormalHippyOutfit_createClass(QuestGrabHippyOutfit, [{ key: "hasShockingLick", value:
...
var QuestGrabBoatVacation = /*#__PURE__*/function () {function QuestGrabBoatVacation() {QuestGrabBoatVacation_classCallCheck(this, QuestGrabBoatVacation);QuestGrabBoatVacation_defineProperty(this, "junkKey",
    ...
    function status() {
      ...
      if ((0,external_kolmafia_namespaceObject.myAdventures)() < 20) {
        return QuestStatus.FASTER_LATER;
      }
...
var QuestFortuneExp = /*#__PURE__*/function () {function QuestFortuneExp() {QuestFortuneExp_classCallCheck(this, QuestFortuneExp);QuestFortuneExp_defineProperty(this, "fam",
    external_kolmafia_namespaceObject.Familiar.get("Grey Goose"));}QuestFortuneExp_createClass(QuestFortuneExp, [{ key: "getId", value:
    ...
    function run() {
      return {
        ...
        outfit: new GreyOutfit("-tie"),
        run: () => {
          (0,external_kolmafia_namespaceObject.cliExecute)("fortune familiar");
        } };
...
var AdventureFinder = /*#__PURE__*/function () {function AdventureFinder() {GreyChooser_classCallCheck(this, AdventureFinder);GreyChooser_defineProperty(this, "defeated", void 0);GreyChooser_defineProperty(this, "viableQuests", void 0);GreyChooser_defineProperty(this, "quester",
    ...
    external_kolmafia_namespaceObject.Familiar.get("Grey Goose"));GreyChooser_defineProperty(this, "goodAbsorbs", void 0);GreyChooser_defineProperty(this, "questLocations", void 0);}GreyChooser_createClass(AdventureFinder, [{ key: "start", value:
...
GreyQuester = /*#__PURE__*/function () {function GreyQuester() {GreyChooser_classCallCheck(this, GreyQuester);GreyChooser_defineProperty(this, "registry",
    ...
    function getDoableQuests() {
      ...
      var tryAdd = (q) => {
        ...
        if (
        q.level() * ((0,external_kolmafia_namespaceObject.haveSkill)(external_kolmafia_namespaceObject.Skill.get("Infinite Loop")) ? 2 : 6) >
...
var TaskEater = /*#__PURE__*/function () {
  ...
  function TaskEater() {TaskEater_classCallCheck(this, TaskEater);TaskEater_defineProperty(this, "prop", "_greyEatenToday");
  ...
  }TaskEater_createClass(TaskEater, [{ key: "run", value:
    ...
    function run() {
      ...
      for (var _i = 0, _Object$keys = Object.keys((0,external_kolmafia_namespaceObject.getInventory)()); _i < _Object$keys.length; _i++) {var i = _Object$keys[_i];
...
var TaskSellCrap = /*#__PURE__*/function () {function TaskSellCrap() {TaskSellCrap_classCallCheck(this, TaskSellCrap);TaskSellCrap_defineProperty(this, "autosells",
    ...
    function run() {var _iterator = TaskSellCrap_createForOfIteratorHelper(
...
var GreyAdventurer = /*#__PURE__*/function () {function GreyAdventurer() {GreyAdventurer_classCallCheck(this, GreyAdventurer);GreyAdventurer_defineProperty(this, "goose",
    ...
    [new TaskEater(), new TaskSellCrap()]);}GreyAdventurer_createClass(GreyAdventurer, [{ key: "runTurn", value:
    ...
    function doPrep(adventure) {
      ...
      if (familiar == this.goose && (0,external_kolmafia_namespaceObject.familiarWeight)(this.goose) >= 6) {
...
function castNoCombatSkills() {
  ...
  (0,external_kolmafia_namespaceObject.myMp)() >= 50)
  {
