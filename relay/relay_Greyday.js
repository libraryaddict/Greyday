  ...
  var greyClipArt = {
    ...
    valid: function valid(value) {var _iterator = _createForOfIteratorHelper(
        value.split(",").map(function (s) {return s.trim();})),_step;try {var _loop = function _loop() {var s = _step.value;
          ...
          var fam = external_kolmafia_namespaceObject.Familiar.all().find(
...
function main() {
  ...
  Object.keys(fields).forEach(function (field) {
    ...
    if ((0,external_kolmafia_namespaceObject.getProperty)(field).toString() !== fields[field]) {
      ...
      field, " changed from ").concat((0,external_kolmafia_namespaceObject.getProperty)(field), " to ").concat(fields[field]));
  ...
  var _iterator = relay_greyday_createForOfIteratorHelper(getGreySettings()),_step;try {for (_iterator.s(); !(_step = _iterator.n()).done;) {var setting = _step.value;
      ...
      var prop = {
        ...
        type: relay_greyday_typeof(setting["default"])
      };
